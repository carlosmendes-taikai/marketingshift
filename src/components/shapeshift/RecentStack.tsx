...
import { registry, inSentence } from "@/components/intents/registry";
              ...
              return (
                ...
                >
                  <motion.button
                    ...
                    onClick={() => onOpen(item)}
                    aria-label={`Edit ${inSentence(def.label)}: ${item.summary}`}
                  ...
                  <button
                    ...
                    aria-label={`Delete ${inSentence(def.label)}: ${item.summary}`}
